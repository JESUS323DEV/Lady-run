-- MOMENTANEO (ver FEATURES.md): primera tanda de precios de marcos de avatar. marco_base (Marco-4/5/6,
-- los 3 primeros son gratis, ver FRAME_GROUPS en ladyRunAvatarFramesCatalog.js) cuesta tavern coin,
-- marco_fondo (todos, son de pago) cuesta Huesin. El precio es el mismo para todas las variantes
-- dentro de cada grupo, no por marco individual.
